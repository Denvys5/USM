...
public final class ElectricItem{
	/**
	 * IElectricItemManager to use for interacting with IElectricItem
	 * ItemStacks.
	 * 
	 * This manager will act as a gateway and delegate the tasks to the final
	 * implementation (rawManager or a custom one) as necessary.
	 */
	public static IElectricItemManager manager;

	/**
	 * Standard IElectricItemManager implementation, only call it directly from
	 * another IElectricItemManager. Use manager instead.
	 */
	public static IElectricItemManager rawManager;

	/**
	 * Register an electric item manager for items not implementing
	 * IElectricItem.
	 * 
	 * This method is only designed for special purposes, implementing
	 * IElectricItem or ISpecialElectricItem instead of using this is faster.
	 * 
