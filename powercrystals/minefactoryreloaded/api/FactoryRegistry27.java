 ...
 * 
 *         To avoid breaking the API, additional FarmingRegistry##s will appear
...
public class FactoryRegistry27{
	...
	/**
	 * Registers a grindable entity with the Grinder using the new grinder
	 * interface. This method will be renamed to the standard
	 * "registerGrindable" on MC 1.6.
	 * 
	 * @param grindable
	 *            The entity to grind.
	 */
	 ...
	 * specified color will make the specified ore more likely. Used by MFR
	 * itself for vanilla: Black (Coal), Light Blue (Diamond), Lime (Emerald),
	 * Yellow (Gold), Brown (Iron), Blue (Lapis), Red (Redstone), and White
	 * (nether quartz).
	 * 
