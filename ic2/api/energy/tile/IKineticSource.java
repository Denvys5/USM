...
public interface IKineticSource{
	/*
	 * Return max kinetic energy transmission peer Tick (only theoretical
	 * bandwidth not available amount)
	 */
	 ...
	 * 
	 * example: You Request 100 units of kinetic energy but the Source have only
	 * 50 units left
	 * 
	 * requestkineticenergy(100) : return 50 : so 50 units of kinetic energy
	 * remove from KineticSource
	 */
