...
public class TileEntityDuplicator extends TileEntity implements
		ISidedInventory {
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (flag != this.isBurning()) {
				Duplicator.updateDuplicatorBlockState(
	...
	private boolean canSmelt() {
		if (this.slots[0] == null) {
			...
			ItemStack itemstack = DuplicatorRecipes.smelting()
