...
public class SlotDuplicator extends Slot
{
    ...
    public SlotDuplicator(EntityPlayer p_i1813_1_, IInventory p_i1813_2_, int p_i1813_3_, int p_i1813_4_, int p_i1813_5_)
    {
    ...
    protected void onCrafting(ItemStack p_75208_1_)
    {
        ...
        if (!this.thePlayer.worldObj.isRemote)
        {
            ...
            float f = DuplicatorRecipes.smelting().func_151398_b(p_75208_1_);
            int j;
