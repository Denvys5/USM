...
public class ExplosionSafeNuke extends Explosion{

	public boolean destroyBlocks = true;
	private int field_77289_h = 256;
	...
	public ExplosionSafeNuke(World world, Entity entity, double d1, double d2, double d3, float f1){
		super(world, entity, d1, d2, d3, f1);
		this.worldObj = world;
