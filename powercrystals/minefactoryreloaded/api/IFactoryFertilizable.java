 ...
 * 
 *         Defines a fertilizable block, and the process to fertilize it. You
 *         can assume that you will never have to check that block ID matches
 *         the one returned by getFertilizableBlockId().
 */
