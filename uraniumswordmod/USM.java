...
public class USM {
	...
	public void initConfiguration(FMLInitializationEvent event){
		Configuration config = new Configuration(new File("config/USM/UraniumSwordMod.cfg"));
		config.load();
		oreuraniumblockID = config.get("Blocks", "Uranium Ore", 500).getInt();
		blockuraniumblockID = config.get("Blocks", "Uranium Block", 502).getInt();
		blocknetherstarblockID = config.get("Blocks", "Nether Star Block", 501).getInt();
		sworduraniumitemID = config.get("Items", "Uranium Sword", 1551).getInt();
		ingotinfuseduraniumitemID = config.get("Items", "Infused Uranium Ingot", 1553).getInt();
		ingoturaniumitemID = config.get("Items", "Uranium Ingot", 1552).getInt();
		stickironitemID = config.get("Items", "Iron Stick", 1550).getInt();
		furnaceuraniumidleblockID = config.get("Tile Entities", "Uranium Furnace", 503).getInt();
		furnaceuraniumactiveblockID = config.get("Tile Entities", "Uranium Furnace Active", 504).getInt();
		config.save();
	}
	...
	public void Load(FMLInitializationEvent event)
	{
		...
		//oreuranium = new OreUranium(500).setUnlocalizedName("Uranium Ore");
		oreuranium = new OreUranium(this.oreuraniumblockID).setUnlocalizedName("Uranium Ore");
        ...
        //blocknetherstar = new BlockNetherStar(501).setUnlocalizedName("Nether Star Block");
        blocknetherstar = new BlockNetherStar(this.blocknetherstarblockID).setUnlocalizedName("Nether Star Block");
        ...
        //blockuranium = new BlockUranium(502).setUnlocalizedName("Block Uranium");
        blockuranium = new BlockUranium(this.blockuraniumblockID).setUnlocalizedName("Block Uranium");
        ...
        //furnaceuraniumidle = new FurnaceUranium(503, false).setUnlocalizedName("Uranium Furnace Idle").setCreativeTab(USM.USMTab);
        furnaceuraniumidle = new FurnaceUranium(this.furnaceuraniumidleblockID, false).setUnlocalizedName("Uranium Furnace Idle").setCreativeTab(USM.USMTab);
        //furnaceuraniumactive = new FurnaceUranium(504, true).setUnlocalizedName("Uranium Furnace Active").setLightValue(0.8F);
        furnaceuraniumactive = new FurnaceUranium(this.furnaceuraniumactiveblockID, true).setUnlocalizedName("Uranium Furnace Active").setLightValue(0.8F);
        ...
        sworduranium = new SwordUranium(this.sworduraniumitemID).setUnlocalizedName("Uranium Sword");
        ...
        stickiron = new StickIron(this.stickironitemID).setUnlocalizedName("Iron Stick");
        ...
        ingoturanium = new IngotUranium(this.ingoturaniumitemID).setUnlocalizedName("Uranium Ingot");
        ...
        ingotinfuseduranium = new IngotInfusedUranium(this.ingotinfuseduraniumitemID).setUnlocalizedName("Infused Uranium Ingot");
...
//Крафты        
	...
	public static final EnumToolMaterial Uranium = EnumHelper.addToolMaterial("Uranium", 3, 768, 9.0F, 71.0F, 50);
}
