...
public class RenderSafeNukePrimed extends Render{

	private RenderBlocks blockRenderer = new RenderBlocks();

	public RenderSafeNukePrimed(){
		this.shadowSize = 0.5F;
	}

	public void doRender(EntitySafeNukePrimed entityNukePrimed, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_){
		GL11.glPushMatrix();
	...
	protected ResourceLocation getEntityTexture(EntitySafeNukePrimed entity){
		return TextureMap.locationBlocksTexture;
	}

	protected ResourceLocation getEntityTexture(Entity entity){
		return this.getEntityTexture((EntitySafeNukePrimed)entity);
	}
	...
	public void doRender(Entity entityNukePrimed, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_){
		this.doRender((EntitySafeNukePrimed)entityNukePrimed, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
	}
}
