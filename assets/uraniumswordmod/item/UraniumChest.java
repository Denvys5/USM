...
public class UraniumChest extends ItemArmor {
    public UraniumChest(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        this.itemIcon = par1IconRegister.registerIcon(USM.modid + ":UraniumChest"); 
    }
