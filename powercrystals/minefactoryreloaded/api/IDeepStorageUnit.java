...
public interface IDeepStorageUnit{
	 ...
	 *         materials in the DSU. May have a stackSize > getMaxStackSize().
	 */
	ItemStack getStoredItemType();

	/**
	 * Sets the total amount of the item currently being stored, or zero if it
	 ...
	 * items to count. Will overwrite any existing stored items.
	 */
