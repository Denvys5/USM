...
//	public static int ingoturaniumblockID;
	...
	public void Load(FMLInitializationEvent event)
	{
        ...
        furnaceuraniumidle = new FurnaceUranium(996, false).setUnlocalizedName("Uranium Furnace Idle").setHardness(3.0F).setCreativeTab(CreativeTabs.tabMaterials);
        furnaceuraniumactive = new FurnaceUranium(997, true).setUnlocalizedName("Uranium Furnace Active").setHardness(3.0F).setLightValue(0.8F);
	...
	public static final EnumToolMaterial Uranium = EnumHelper.addToolMaterial("Uranium", 3, 768, 9, 2, 25);
