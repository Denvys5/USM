...
public class USMWorldGenerator extends WorldGenerator{
	...
	public USMWorldGenerator(Block block, int par2, int metadata){
					...
					for(int var41 = var33; var41 <= var36; ++var41){
						...
						if(var39 * var39 + var42 * var42 < 1.0D){
							for(int var44 = var34; var44 <= var37; ++var44){
								...
								if(var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && world.getBlock(var38, var41, var44) == Blocks.stone){
									world.setBlock(var38, var41, var44, this.minableBlock, this.metadata, 2);
								}
							}
						}
					}
