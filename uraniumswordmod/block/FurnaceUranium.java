...
public class FurnaceUranium extends BlockContainer {
    ...
    public void registerIcons(IconRegister iconRegister){
    	...
    	//this.blockIcon = iconRegister.registerIcon(USM.modid +":FurnaceUranium_side");
    	//this.iconFront = iconRegister.registerIcon(USM.modid + ":" + (this.isActive ? "FurnaceUranium_active" : "FurnaceUranium_idle"));
	...
	public void breakBlock(World world, int x, int y, int z, int oldBlockID, int oldMetadata){
		if(!keepInventory){
			TileEntityFurnaceUranium tileentity = (TileEntityFurnaceUranium) world.getBlockTileEntity(x, y, z);
			if(tileentity != null){
