...
/**
 * 
 * You should not implement this yourself. Instead, use this to look for cables
 * to notify from your IConnectableRedNet as this does not require a block
 * update. This will be implemented on the cable's Block class.
 * 
 */
public interface IRedNetNetworkContainer{
	 ...
	 * @param x
	 *            The x-coordinate of this cable.
	 * @param x
	 *            The y-coordinate of this cable.
	 * @param x
	 *            The z-coordinate of this cable.
	 */
